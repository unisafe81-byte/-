...
import { FusionAnalysisResponse, YouTubeSearchResponse, YouTubeVideo, ABPlanResponse, MasterScriptResponse, ChannelAnalyticsItem, ChannelAnalyticsResponse } from "./types";
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans flex flex-col transition-all duration-300">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 flex-1 w-full space-y-8">
        ...
        {/* TAB 3: CHANNEL ANALYTICS DASHBOARD */}
        {activeTab === "analytics" && (
            ...
            <div className="bg-gradient-to-r from-gray-950 to-emerald-950/20 border border-emerald-500/10 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <div className={`flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-bold border ${
                  analyticsResult?.isRealData ? "bg-emerald-950/40 text-emerald-400 border-emerald-500/25" : "bg-slate-900 text-gray-400 border-gray-700"
                }`}>
